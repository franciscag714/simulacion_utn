...
if args.z is not None:
    if (args.z !='primera docena' and args.z !='segunda docena' and args.z !='tercera docena'):
        print("Error: la zona elegida (-z) debe ser 'primera docena', 'segunda docena' o 'tercera docena'.")
        sys.exit(1)
    mundo=args.z
    eleccion = 4
if args.d is not None:
    if (args.d !='primera columna' and args.d !='segunda columna' and args.d !='tercera columna'):
        print("Error: la columna elegida (-d) debe ser 'primera columna', 'segunda columna' o 'tercera columna'.")
        sys.exit(1)
    mundo = args.d
    eleccion = 5


print(f"Tiradas: {args.c}, Corridas: {args.n}, Número elegido: {args.e}, Estrategia elegida: {args.s}, Capital elegido: {args.a}, Color elegido: {args.b}, Paridad elegida: {args.p}, Zona elegida: {args.z}, Columna elegida: {args.d} ")
...
for i in range(num_corridas):
    ...
    for j in range(num_tiradas):
        if flag == False: 
            ...
            if (est_elegida == "m"):
                ap, capital = martingala(apuesta_inicial, mundo, mundo_a_comparar, capital_inicial)
